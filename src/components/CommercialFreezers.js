...
const CommercialFreezers = ({id, url, modelNum, type, description, price, isFavorite}) => {
		return (
		<div>
		<Helmet>
      ...
      <title>Commercial Freezers - Radio Vision</title>
    </Helmet>
...
export default CommercialFreezers